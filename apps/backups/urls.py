...
from apps.backups.views import index ,rule_new,StepAddView,steps_listview,jobs
...
urlpatterns = [
    ...
    path('backups/jobs', jobs.as_view(), name="jobs_list"),
    path('backups/rotation/<int:pk>', StepAddView.as_view(), name="add_step"),
